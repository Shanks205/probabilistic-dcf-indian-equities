# Shilchar Technologies Citation and Data Reconciliation Map
...
|---|---|---|
| Official annual report | Shilchar Technologies FY2024-25 annual report | Primary audited financial source |
...
| Capex | Cash-flow statement | Pending | Map purchase of PPE and capacity expansion assets |
| Working capital inputs | Balance sheet / model assumption | Pending | Map receivables, inventory, payables and order-cycle working capital |
...
Shilchar Technologies should be reconciled as a high-ROCE industrial growth / transformer manufacturing case. Special attention should be given to transformer demand, renewable-energy and grid capex, export contribution, capacity expansion, high-margin sustainability, receivables, inventory, and premium valuation expectations.
