# SJS Enterprises Citation and Data Reconciliation Map
...
|---|---|---|
| Official annual report | SJS Enterprises FY2024-25 annual report | Primary audited financial source |
...
| Capex | Cash-flow statement | Pending | Map purchase of PPE / product-development assets |
| Working capital inputs | Balance sheet / model assumption | Pending | Map receivables, inventory and payables |
...
| Acquisition-related items | Annual report / notes | Pending | Map acquisition/integration-related items if used in discussion |
...
SJS Enterprises should be reconciled as an auto ancillary / decorative aesthetics / premiumization case. Special attention should be given to content per vehicle, customer/platform mix, export contribution, acquisitions, margin durability, working capital, and premium valuation expectations.
