# Triveni Turbine Citation and Data Reconciliation Map
...
|---|---|---|
| Official annual report | Triveni Turbine FY2024-25 annual report | Primary audited financial source |
...
| Working capital inputs | Balance sheet / model assumption | Pending | Map receivables, inventory, contract assets and payables if used |
...
Triveni Turbine should be reconciled as a capital goods / order-book conversion case. Special attention should be given to order inflow, export growth, aftermarket/service mix, margin sustainability, working-capital discipline, and capacity utilization.
