# JB Chemicals and Pharmaceuticals Citation and Data Reconciliation Map
...
|---|---|---|
| Official annual report | JB Chemicals and Pharmaceuticals FY2024-25 annual report | Primary audited financial source |
...
| ROCE / ROE | Annual report / model calculation | Pending | Reconcile return ratios or document calculation |
| Capex | Cash-flow statement | Pending | Map purchase of PPE, intangible assets and manufacturing investments |
| Working capital inputs | Balance sheet / model assumption | Pending | Map receivables, inventory, payables and pharma channel working capital |
...
| Segment / geography data | Annual report / investor presentation | Pending | Map domestic formulations, international formulations and CDMO contribution if used in discussion |
...
JB Chemicals and Pharmaceuticals should be reconciled as a stable pharma / branded generics / defensive earnings case. Special attention should be given to domestic formulation growth, chronic-therapy brand strength, international formulations, CDMO contribution, regulatory risk, acquired-brand performance, margin durability, and defensive premium valuation expectations.
