# Sharda Cropchem Citation and Data Reconciliation Map
...
|---|---|---|
| Official annual report | Sharda Cropchem FY2024-25 annual report | Primary audited financial source |
...
| Capex | Cash-flow statement | Pending | Map purchase of PPE / intangible registrations where relevant |
| Working capital inputs | Balance sheet / model assumption | Pending | Map receivables, inventory, payables and registration-led cash cycle |
...
Sharda Cropchem should be reconciled as a working-capital-sensitive agrochemical case. Special attention should be given to receivables, inventory, registration-led business model, cash conversion, geographic revenue mix, product launches, and margin normalization.
