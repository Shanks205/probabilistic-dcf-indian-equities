# Polycab India Citation and Data Reconciliation Map
...
|---|---|---|
| Official annual report | Polycab India FY2024-25 annual report | Primary audited financial source |
...
| Working capital inputs | Balance sheet / model assumption | Pending | Map receivables, inventory and payables by segment where possible |
...
| Segment revenue and margins | Annual report / investor presentation | Pending | Map wires and cables, FMEG and EPC contribution if used in discussion |
...
Polycab India should be reconciled as a quality compounder / cables and electricals case. Special attention should be given to wires and cables growth, FMEG margin improvement, EPC contribution, exports, working-capital discipline, capex, and premium valuation expectations.
