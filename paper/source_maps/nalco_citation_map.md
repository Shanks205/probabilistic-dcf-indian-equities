# NALCO Citation and Data Reconciliation Map
...
|---|---|---|
| Official annual report | NALCO FY2024-25 annual report | Primary audited financial source |
...
| Capex | Cash-flow statement | Pending | Map purchase of PPE / mining and refinery assets |
| Working capital inputs | Balance sheet / model assumption | Pending | Map inventories, receivables, payables and commodity-linked working capital |
...
NALCO should be reconciled as a cyclical commodity case. Special attention should be given to alumina and aluminium price sensitivity, mid-cycle margin normalization, cash balance, commodity working capital, government ownership context, and capex cycle assumptions.
